package com.flavio.calculadoradenotas

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import com.flavio.calculadoradenotas.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    fun calcularMedia(){
        ...
        if (media >=5 && numeroFaltas <=20){
            ...
            resultado.setTextColor(getColor(R.color.green_700))
        }else if(numeroFaltas >20 && media <5) {
            resultado.setText("Aluno foi Reprovado por faltas e por nota \n Média final $media")
